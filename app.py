...
if df_history is not None:
    ...
    with tab1:
        ...
        script_dir = os.path.dirname(os.path.abspath(__file__))
        path_raw = os.path.join(script_dir, f"results/02_Forecasting/{loja_sel.capitalize()}/{cenario_sel}/forecast_values.csv")
    ...
    with tab3:
        ...
        path_comp = os.path.join(script_dir, f"results/02_Forecasting/{loja_sel.capitalize()}/{cenario_sel}/prophet_components.csv")
    ...
    with tab4:
        ...
        path_feat = os.path.join(script_dir, f"results/02_Forecasting/{loja_sel.capitalize()}/{cenario_sel}/feature_importance.csv")
