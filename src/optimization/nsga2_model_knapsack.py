...
from utils.profit_logic_knapsack import optimize_weekly_wrapper  # função de avaliação real
...
def extract_pareto_solutions(res, second_obj_name="staff") -> dict:
    """
    Organiza o resultado do minimize() num dicionário de trabalho.

    Chaves retornadas:
      'pareto_F'  — array (n, 2): [-Lucro, SegundoObjetivo]
      'pareto_X'  — array (n, 21): variáveis de decisão
      'lucro'     — array (n,): lucro positivo, ordenado decrescentemente
      'second_obj' — array (n,): valores do segundo objetivo correspondente
    ...
    return {
        ...
        "second_obj": second_obj_col[order],
        "second_obj_name": second_obj_name,
...
def run_optimization(
    ...
    Args:
        ...
        second_obj_name: Nome do segundo objetivo (usado no extrator).
    ...
    return extract_pareto_solutions(res, second_obj_name=second_obj_name)
